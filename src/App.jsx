...
function App() {
  ...
  const columnDefs = [
    ...
    { field: 'isbn', headerName: "lsbn", sortable: true, filter: true},
  ...
  const fetchBooks = () => {
    fetch('https://bookstore-37639-default-rtdb.europe-west1.firebasedatabase.app/books/.json')
  ...
  const deleteBook = (id) => {
    fetch(`https://bookstore-37639-default-rtdb.europe-west1.firebasedatabase.app/books/${id}.json`,
    {
      method: 'DELETE',
    })
    .then(_ => fetchBooks())
